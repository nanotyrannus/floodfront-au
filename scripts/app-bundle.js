...
define('leaflet-map/leaflet-map',["require", "exports", "aurelia-router", "../rest/rest-service", "../user/user-service", "aurelia-framework", "./MarkerModel", "leaflet", "./marker-note/marker-note", "aurelia-event-aggregator"], function (require, exports, aurelia_router_1, rest_service_1, user_service_1, aurelia_framework_1, MarkerModel_1, leaflet_1, marker_note_1, aurelia_event_aggregator_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var LeafletMap = (function () {
        function LeafletMap(router, rest, userService, markerNote, eventAggregator) {
            var _this = this;
            this.router = router;
            this.rest = rest;
        ...
        LeafletMap.prototype.getMarkers = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.rest.postWithRetry("marker/2/retrieve", { "email": "ryan" })];
                        case 1:
                            data = _a.sent();
